CDECK  ID>, FOPTE2.
       SUBROUTINE FOPTE2(M,U2,F2,XAUX)
*-----------------------------------------------------------------------
*   FOPTE2 - Integrates the energy over the wire.
...
*   The parameter MXNBMC must equal MXGNAM (sequence MAGBPARM) !
     ...
     -      LFGRAV,LFELEC,LFEXTR,LFWARN,LZROPR,LFITER
       DOUBLE PRECISION U2(*),F2(*),XAUX(*),DGMLT1,DDX,DDY
       INTEGER L,M
       EXTERNAL FOPTE1,DGMLT1
       COMMON /FEODAT/ DDX,DDY
*** Loop over the positions.
       DO 10 L=1,M
       XAUX(2)=U2(L)
       F2(L)=DGMLT1(FOPTE1,0.0D0,
     -      (1-(2*XAUX(2)/U(IW))**2)*SQRT(DDX**2+DDY**2),3,6,XAUX)
10     CONTINUE
       END
