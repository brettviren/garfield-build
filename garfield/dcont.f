CDECK  ID>, DCONT.
       SUBROUTINE DCONT(X0,Y0,FVAL,ILOC)
*-----------------------------------------------------------------------
*   DCONT  - Returns the function value of to the contour routine
...
*   The parameter MXNBMC must equal MXGNAM (sequence MAGBPARM) !
     ...
     -         LSYNCH,LINPRD,LUNOUT,JFAIL,JEXMEM
       REAL RES(1),VAR(MXVAR),QPLT,X0,Y0,FVAL,VOLT
...
*** Transform the coordinates.
       ...
       VAR(23)=FPROJ(1,3)*X0+FPROJ(2,3)*Y0+FPROJ(3,3)
