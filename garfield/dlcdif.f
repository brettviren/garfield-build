CDECK  ID>, DLCDIF.
       SUBROUTINE DLCDIF(SIGMA)
*-----------------------------------------------------------------------
*   DLCDIF - Returns the diffusion.
*   (Last changed on  7/ 2/97.)
*-----------------------------------------------------------------------
C       implicit none
...
*   The parameter MXNBMC must equal MXGNAM (sequence MAGBPARM) !
     ...
     -      IPTECH,LREPSK,LKINK,LSTMAX,LEQSRT,LEQCRS,LEQMRK,LAVPRO
       REAL SIGMA
*** If the particle is an electron, compute as usual.
       IF(IPTYPE.EQ.1)THEN
            IF(GASOK(3).AND.GASOK(8))THEN
                 CALL DLCDF2(SIGMA)
            ELSEIF(GASOK(3))THEN
                 CALL DLCDF1(SIGMA)
            ELSE
                 SIGMA=0.0
            ENDIF
*** If the particle is an ion, return 0.
       ELSE
            SIGMA=0
       ENDIF
       END
