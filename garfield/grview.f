CDECK  ID>, GRVIEW.
       SUBROUTINE GRVIEW(VXMIN,VYMIN,VXMAX,VYMAX)
*-----------------------------------------------------------------------
*   GRVIEW - Computes the view limits of the current projection.
...
*** R-PHI and X-Y types view.
       IF(POLAR.OR.PRVIEW.EQ.'R-PHI'.OR.PRVIEW.EQ.'X-Y')THEN
            VXMIN=REAL(GXMIN)
            VYMIN=REAL(GYMIN)
            VXMAX=REAL(GXMAX)
            VYMAX=REAL(GYMAX)
...
*** CUT type view.
       ELSEIF(PRVIEW.EQ.'CUT')THEN
            CALL GRAXIC(VVXMIN,VVYMIN,VVXMAX,VVYMAX,' ','VIEW')
            VXMIN=REAL(VVXMIN)
            VYMIN=REAL(VVYMIN)
            VXMAX=REAL(VVXMAX)
            VYMAX=REAL(VVYMAX)
...
*** Other projections are not known currently.
       ELSE
            PRINT *,' !!!!!! GRVIEW WARNING : Projection ',PRVIEW,
