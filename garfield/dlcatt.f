CDECK  ID>, DLCATT.
       SUBROUTINE DLCATT(FACTOR)
*-----------------------------------------------------------------------
*   DLCATT - Routine returning the attachment losses for the current
*            drift line. Uses either DLCAT11 for drift lines that have
*            been computed with RKF or DLCAT22 for MC drift lines.
*            integration.
*   VARIABLES : FACTOR     : The attachment losses.
