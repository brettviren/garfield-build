...
*** Set the proper type of particle for plotting, first electron.
       IF(IPTYPE.EQ.1)THEN
...
*   Anything else.
       ELSE
            PRINT *,' !!!!!! DLCPLT WARNING : Current drift line'//
     -           ' is of unknown type; selecting FUNCTION-1'//
     -           ' representation.'
            CALL GRATTS('FUNCTION-1','POLYLINE')
       ENDIF
*** Plot the drift line.
       CALL PLAGPL(NU,XU,YU,ZU)
       END
