CDECK  ID>, TRADEL.
       SUBROUTINE TRADEL(pnevt, pqevt)
*-----------------------------------------------------------------------
*   TRADEL - Runs Heed for an delta electron.
...
c	Notation nh2 is number of 2-dimension histogram	
	...
	save / chhist /
     ...
     +  rseed, sseed
       ...
       INTEGER PNEVT,PQEVT,NQUP
*** Identification.
       IF(LIDENT)PRINT *,' /// ROUTINE TRADEL ///'
...
*** Initialisations.
       ...
       call Inidel
       call Inicel
*** Add a ficticious parent virtual gamma.
       qgvga(1)=1
       pntgvga(1,qgvga(1),1)=0
       pntgvga(2,qgvga(1),1)=0
       pntgvga(3,qgvga(1),1)=0
       egvga(qgvga(1),1)=TRENER
       ganumat(qgvga(1),1)=0
       ganumshl(qgvga(1),1)=0
*** Add a single delta electron.
       qdel=1
       pntdel(1,qdel)=0
       pntdel(2,qdel)=0
       pntdel(3,qdel)=0
