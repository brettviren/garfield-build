...
*-----------------------------------------------------------------------
*   GAS43  - C2F4H2 cross sections.
*   Author: Steve Biagi, with 1 correction from Steve Biagi.
*   (Last changed on 11/12/07.)
*-----------------------------------------------------------------------
...
*** Next line corrected (RV 11/12/07).
C      CHARACTER*15 SCRPT(226)
