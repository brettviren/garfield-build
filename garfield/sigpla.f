CDECK  ID>, SIGPLA.
       SUBROUTINE SIGPLA(XPOS,YPOS,ZPOS,EX,EY,EZ,MX,MY,IPLANE)
*-----------------------------------------------------------------------
*   SIGPLA - Routine redirecting the calls for reduced periodicity field
*            vectors.
...
*   The parameter MXNBMC must equal MXGNAM (sequence MAGBPARM) !
     ...
     -      IWORK(MXWIRE),DUMMY(2*MXWIRE+6)
       ...
       REAL XPOS,YPOS,ZPOS,EX,EY,EZ
       INTEGER IPLANE,MX,MY
*** Initial settings.
       EX=0
       EY=0
       EZ=0
*** Various cell types.
       ...
       ELSE
            PRINT *,' ###### SIGPLA ERROR   : Unknown signal field'//
     -           ' type ',FCELTP,' received; program error.'
       ENDIF
