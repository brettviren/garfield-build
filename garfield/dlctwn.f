CDECK  ID>, DLCTWN.
       SUBROUTINE DLCTWN(FACTOR)
*-----------------------------------------------------------------------
*   DLCTWN - Routine returning the multiplication factor for the current
*            drift line. Uses either DLCDF1 for drift lines that have
*            been computed with RKF or DLCDF2 for MC drift lines.
*            integration.
*   VARIABLES : FACTOR     : The multiplication factor.
*   (Last changed on  9/12/01.)
*-----------------------------------------------------------------------
       implicit none
...
*** Projected integration ...
       ELSEIF(LAVPRO)THEN
            CALL DLCTW2(FACTOR)
*** Integration over the true step length ...
       ELSE
            CALL DLCTW1(FACTOR)
       ENDIF
       END
