...
*** Set a default particle type and energy (a 1 GeV mu-)
       ...
       TRENER=1000.0
       TRELEC=0.1
*** Typical SRIM cluster size: automatic
       TRNSRM = -1.0
*** Include SRIM's longitudinal and transverse straggling
       LDLSRM=.TRUE.
       LDTSRM=.TRUE.
*** Use fast Vavilov generator
       LTRVVL=.FALSE.
*** SRIM fluctuation model: Combined
       ITFSRM = 4
*** Particle identifier.
       PARTID='Unknown'
       PNAME='Unknown'
