...
*   The parameter MXNBMC must equal MXGNAM (sequence MAGBPARM) !
     ...
     -      PERRX,PERRY,PERRZ,LBGFMP,CELSET,LDIPOL,BEMSET
       ...
       DOUBLE PRECISION XX(4*MXSHOT+2),F(*),COOR,XST(2),DXST(2),WORK(12)
       INTEGER N,I,J
       EXTERNAL OPTSTP
...
*   Store the differences as function value.
       IF(I.LT.NSHOT)THEN
            F(4*I+1)=XST(1)-XX(4*I+3)
            F(4*I+2)=XST(2)-XX(4*I+4)
            F(4*I+3)=DXST(1)-XX(4*I+5)
            F(4*I+4)=DXST(2)-XX(4*I+6)
       ELSE
            F(4*NSHOT+1)=XST(1)
            F(4*NSHOT+2)=XST(2)
       ENDIF
